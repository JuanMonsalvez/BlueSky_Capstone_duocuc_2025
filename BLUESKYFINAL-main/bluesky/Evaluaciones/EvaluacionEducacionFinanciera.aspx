<%@ Page Title="Evaluación: Educación Financiera Básica" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionEducacionFinanciera.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionEducacionFinanciera" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Educación Financiera Básica</h2>
