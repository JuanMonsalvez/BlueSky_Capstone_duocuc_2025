<%@ Page Title="Evaluación: Herramientas Básicas de MS Office" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionHerramientasOficceBasica.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionHerramientasOficceBasica" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Herramientas Básicas de MS Office</h2>
