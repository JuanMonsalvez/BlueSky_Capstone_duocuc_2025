<%@ Page Title="Evaluación: Herramientas de Gestión de Procesos" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionHerramientasDeProceso.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionHerramientasDeProceso" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Herramientas de Gestión de Procesos</h2>
