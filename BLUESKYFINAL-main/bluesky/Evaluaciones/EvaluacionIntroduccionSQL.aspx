<%@ Page Title="Evaluación: Introducción a SQL" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionIntroduccionSQL.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionIntroduccionSQL" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Introducción a SQL</h2>
