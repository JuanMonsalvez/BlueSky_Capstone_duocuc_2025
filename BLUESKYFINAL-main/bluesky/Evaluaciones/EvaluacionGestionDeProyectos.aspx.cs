...
{
    public partial class EvaluacionGestionDeProyectos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int cursoId = 5; // Gestión de Proyectos — Herramientas Claves (ajusta si es otro ID)
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 5; // Gestión de Proyectos
            DataTable dtAll = ViewState["dtAll"] as DataTable;
