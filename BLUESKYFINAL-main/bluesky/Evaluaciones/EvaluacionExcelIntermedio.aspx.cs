...
{
    public partial class EvaluacionExcelIntermedio : System.Web.UI.Page
    {
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 10; // Excel Intermedio
            DataTable dtAll = ViewState["dtAll"] as DataTable;
                ...
                using (var tx = cn.BeginTransaction())
                {
                    try
                    {
                      ...
                      VALUES (@rut, @curso, NOW(), @puntaje, @numc);", cn, tx))
                        ...
                        // Insertar respuestas del alumno en respuesta_intento
                        foreach (RepeaterItem item in rptPreguntas.Items)
                        {
            ...
            // 3) Mostrar resultado (igual que antes)
            pnlEvaluacion.Visible = false;
