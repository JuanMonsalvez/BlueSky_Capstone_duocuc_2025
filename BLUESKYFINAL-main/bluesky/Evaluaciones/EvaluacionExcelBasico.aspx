<%@ Page Title="Evaluación: Excel Básico" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionExcelBasico.aspx.cs"
    Inherits="bluesky.StartCursos.EvaluacionExcelBasico" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <style>
        /* Fondo general suave para diferenciar del contenido */
        body {
            background-color: #f4f6fb;
        }

        /* Tarjeta principal de la evaluación */
        .eval-card {
            max-width: 960px;
            margin: 30px auto;
            border-radius: 12px;
        ...
        /* Cada pregunta como tarjeta interna */
        .q-card {
            border-radius: 10px;
        ...
        .q-choices {
            ...
            /* Estilizar RadioButtonList (Bootstrap-like) */
            .q-choices .aspNetDisabled {
                opacity: 0.7;
            }

            /* Cada ítem del RadioButtonList */
            .q-choices input[type="radio"] {
                margin-right: 8px;
            }

            /* Opciones en bloque con hover suave */
            .q-choices label {
                display: block;
                padding: 6px 10px;
                border-radius: 8px;
                ...
                /* Hover sobre la alternativa */
                .q-choices label:hover {
                    background-color: #e5efff;
                }

            /* Cuando el radio está seleccionado (usa el + label típico en WebForms) */
        ...
        /* Botón principal (por si no usas el btn-success de Bootstrap) */
        .btn.btn-success {
            padding: 10px 26px;
            font-size: 1rem;
            border-radius: 999px;
        ...
        #pnlResultado .card-body {
            ...
            /* Mejora visual del texto del resultado */
            #pnlResultado .card-body p {
                margin-bottom: 8px;
                font-size: 0.98rem;
            }

        /* Botón volver a cursos más redondeado */
        #btnVolverCursos {
            border-radius: 999px;
            padding: 8px 20px;
            font-weight: 500;
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Excel Básico</h2>
