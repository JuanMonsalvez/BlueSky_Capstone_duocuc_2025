<%@ Page Title="Evaluación: Excel Intermedio" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionExcelIntermedio.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionExcelIntermedio" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Excel Intermedio</h2>
