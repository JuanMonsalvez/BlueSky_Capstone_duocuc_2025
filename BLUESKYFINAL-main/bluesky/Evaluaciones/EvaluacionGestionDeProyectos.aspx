<%@ Page Title="Evaluación: Gestión de Proyectos" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionGestionDeProyectos.aspx.cs"
    Inherits="bluesky.Admin.EvaluacionGestionDeProyectos" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Gestión de Proyectos</h2>
