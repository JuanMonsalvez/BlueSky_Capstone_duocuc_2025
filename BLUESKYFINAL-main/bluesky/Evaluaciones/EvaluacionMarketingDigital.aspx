<%@ Page Title="Evaluación: Marketing Digital" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionMarketingDigital.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionMarketingDigital" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Marketing Digital</h2>
