...
{
    public partial class EvaluacionIntroduccionSQL : System.Web.UI.Page
    {
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 12; // Introducción a SQL
            DataTable dtAll = ViewState["dtAll"] as DataTable;
            ...
            // 2) Guardar intento + respuestas dentro de una transacción
            using (var cn = new MySqlConnection(cs))
            {
                cn.Open();
                ...
                using (var tx = cn.BeginTransaction())
                {
                    try
                    {
                      ...
                      VALUES (@rut, @curso, NOW(), @puntaje, @numc);", cn, tx))
                        ...
                        // Insertar las respuestas del alumno
                        foreach (RepeaterItem item in rptPreguntas.Items)
                        {
        ...
        protected void btnCertificado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Introducción a SQL";
