...
{
    public partial class EvaluacionPowerPointIntermedio : System.Web.UI.Page
    {
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 11; // PowerPoint Intermedio
            DataTable dtAll = ViewState["dtAll"] as DataTable;
            ...
            // 2) Insertar intento + respuestas dentro de la misma transacción
            using (var cn = new MySqlConnection(cs))
            {
                cn.Open();
        ...
        protected void btnCertificado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "PowerPoint Intermedio";
