<%@ Page Title="Evaluación: Word Básico" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionWordBasico.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionWordBasico" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Word Básico</h2>
