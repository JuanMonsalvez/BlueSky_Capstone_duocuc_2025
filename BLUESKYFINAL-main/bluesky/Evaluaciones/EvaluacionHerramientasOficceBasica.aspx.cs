...
{
    public partial class EvaluacionHerramientasOficceBasica : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int cursoId = 6; // Herramientas Básicas de MS Oficce (ajusta si es otro ID)
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 6; // Herramientas Básicas de MS Office
            DataTable dtAll = ViewState["dtAll"] as DataTable;
            ...
            // 2) Guardar intento + respuestas en una sola transacción
            using (var cn = new MySqlConnection(cs))
            {
                cn.Open();
