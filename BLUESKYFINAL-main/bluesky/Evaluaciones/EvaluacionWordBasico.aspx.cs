...
{
    public partial class EvaluacionWordBasico : System.Web.UI.Page
    {
        ...
        private void CargarPreguntasYAlternativas(int cursoId)
        {
            ...
            {
                // IMPORTANTE: asegúrate de tener columna curso_id en 'pregunta'
                cmd.Parameters.AddWithValue("@curso", cursoId);
                cn.Open();
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            using (var cn = new MySqlConnection(cs))
            {
                ...
                using (var tx = cn.BeginTransaction())
                {
                    ...
                    {
                        tx.Rollback(); // evitar datos inconsistentes
                        throw;
                    }
                }
            }
