...
{
    public partial class EvaluacionHerramientasDeOrganizacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int cursoId = 7; // Herramientas de Organización (ajusta si es otro ID en tu BD)
        ...
        protected void btnFinalizar_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 7; // Herramientas de Organización
            DataTable dtAll = ViewState["dtAll"] as DataTable;
            ...
            // 2) Guardar intento + respuestas en transacción
            using (var cn = new MySqlConnection(cs))
            {
                cn.Open();
                ...
                using (var tx = cn.BeginTransaction())
                {
                    try
                    {
                      ...
                      VALUES (@rut, @curso, NOW(), @puntaje, @numc);", cn, tx))
                        ...
                        // Insertar respuestas en respuesta_intento
                        foreach (RepeaterItem item in rptPreguntas.Items)
                        {
