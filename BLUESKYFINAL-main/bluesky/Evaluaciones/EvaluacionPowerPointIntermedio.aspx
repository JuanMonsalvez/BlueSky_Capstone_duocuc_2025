<%@ Page Title="Evaluación: PowerPoint Intermedio" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionPowerPointIntermedio.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionPowerPointIntermedio" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — PowerPoint Intermedio</h2>
