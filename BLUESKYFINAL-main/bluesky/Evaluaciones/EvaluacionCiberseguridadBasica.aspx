<%@ Page Title="Evaluación: Ciberseguridad Básica" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EvaluacionCiberseguridadBasica.aspx.cs"
    Inherits="bluesky.Evaluaciones.EvaluacionCiberseguridadBasica" %>
    ...
    <asp:Panel ID="pnlEvaluacion" runat="server" Visible="false">
        <div class="card eval-card">
            <div class="eval-header">
                <h2 class="eval-title">Evaluación — Ciberseguridad Básica</h2>
