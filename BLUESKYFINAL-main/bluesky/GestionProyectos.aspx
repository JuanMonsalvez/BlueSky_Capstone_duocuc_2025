<%@ Page Title="Curso: Gestión de proyectos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GestionProyectos.aspx.cs" Inherits="bluesky.GestionProyectos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
        style="background-image: url('<%: ResolveUrl("~/images/gestion-proyectos1.png") %>');"
        aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>

        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Gestión de Proyectos: Herramientas claves</h1>
            <br />
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Profesionales, jefaturas y emprendedores que lideran o coordinan iniciativas
                y necesitan planificar, ejecutar y dar seguimiento a proyectos con herramientas prácticas.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Manejo básico de PC, suites de oficina y colaboración online.</li>
                    <li>Deseable: nociones de Excel (tablas, filtros) y trabajo en equipo.</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    ...
                    <li>Cuenta en una herramienta de gestión (Trello, Asana o Jira) para prácticas.</li>
                    <li>Plantillas provistas en formato Excel/Google Sheets y PDF.</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                ...
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fundamentos y ciclo de vida</h3>
                    <p class="mod-card__subtitle">Marco, fases y roles</p>
                    <ul class="mod-card__list">
                        <li>Qué es un proyecto y su ciclo: inicio, planificación, ejecución, control, cierre</li>
                        <li>Áreas de conocimiento (visión PMBOK) vs. enfoques ágiles</li>
                        <li>Roles, stakeholders y gobierno del proyecto</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Alcance, tiempo y recursos</h3>
                    <p class="mod-card__subtitle">WBS, cronograma y RACI</p>
                    <ul class="mod-card__list">
                        <li>Definición de alcance y entregables; Estructura de Desglose (WBS)</li>
                        <li>Gantt práctico: dependencias, holguras, ruta crítica (nociones)</li>
                        <li>Matriz RACI y asignación de equipo/capacidades</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Costos, riesgos y calidad</h3>
                    <p class="mod-card__subtitle">Estimación, matrices y checklists</p>
                    <ul class="mod-card__list">
                        <li>Estimación y presupuesto: partidas, reservas y control</li>
                        <li>Matriz de riesgos: probabilidad/impacto, respuesta y seguimiento</li>
                        <li>Plan de calidad y criterios de aceptación</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Ejecución ágil y seguimiento</h3>
                    <p class="mod-card__subtitle">Kanban/ Scrum y reportes</p>
                    <ul class="mod-card__list">
                        <li>Tableros Kanban/Scrum: backlog, sprints, WIP y ceremonias</li>
                        <li>Indicadores: % avance, hitos, burn-down (nociones)</li>
                        <li>Reportes ejecutivos y cierre con retrospectiva</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos y ciclo de vida</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Proyectos vs. operaciones. Beneficios, restricciones y triángulo de hierro.</li>
                        <li>Ciclo de vida, entregables por fase y criterios de éxito.</li>
                        <li>Stakeholders: mapeo, influencia y expectativas.</li>
                        <li>Agile vs. predictivo: cuándo usar cada enfoque (visión práctica).</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Alcance, tiempo y recursos</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Herramientas para definir alcance (WBS, criterios “out of scope”).</li>
                        <li>Construcción de cronograma: dependencias, holguras y ruta crítica (nociones).</li>
                        <li>Asignación de recursos y carga de trabajo con matriz RACI.</li>
                        <li>Plantilla de plan base (baseline) para seguimiento.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Costos, riesgos y calidad</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Estimación bottom-up/top-down y presupuesto por paquetes de trabajo.</li>
                        <li>Matriz de riesgos: registro, respuesta y triggers.</li>
                        <li>Calidad: checklists, revisiones por pares y criterios de aceptación.</li>
                        <li>Noción de Valor Ganado (PV, EV, AC) para control básico.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Ejecución ágil y seguimiento</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Implementación de tableros Kanban/Scrum (Trello/Asana/Jira).</li>
                        <li>KPIs: avance, hitos, burn-down y bloqueadores.</li>
                        <li>Reportes ejecutivos y gestión de cambios.</li>
                        <li>Cierre: lecciones aprendidas y handover.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <!-- ================================
     ...
     (misma estructura visual que Excel/Ciberseguridad)
     ================================ -->
            ...
            <ul class="methodology-grid" role="list">
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="1" aria-labelledby="m1-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Clases en vivo con demostraciones, construcción de WBS y Gantt, tableros ágiles y plantillas descargables.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul class="method-list">
                                ...
                                <li>Plantillas: WBS, cronograma, RACI, matriz de riesgos y reportes.</li>
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="2" aria-labelledby="m2-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Quiz por módulo y entregables: WBS + cronograma, RACI, matriz de riesgos y reporte ejecutivo.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul>
                                ...
                                <li>Entregables prácticos con rúbrica por criterio (alcance, tiempo, riesgos).</li>
    ...
    <!-- SCRIPTS: MODAL METODOLOGÍA (igual que Excel/Ciberseguridad) -->
    <script>
        (function () {
