...
{
    public partial class CiberseguridadBasico : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/Ciberseguridad_basica_tacticas_y_herramientas.pptx");
            string fileName = "Ciberseguridad_basica_tacticas_y_herramientas.pptx";
    ...
    out int totalIntentos, out bool ultimoFueAprobado)
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 4; // <<< ID del curso "Ciberseguridad Básica" (ajusta si tu BD usa otro)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionCiberseguridadBasica.aspx");
        }
        ...
        protected void btnRealizarEvalIgual_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 4; // mismo ID que arriba
            int totalIntentos;
            bool ultimoFueAprobado;
            ObtenerEstadoIntentos(rut, cursoId, out totalIntentos, out ultimoFueAprobado);
