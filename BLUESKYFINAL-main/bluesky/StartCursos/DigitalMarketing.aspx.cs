...
namespace bluesky.StartCursos
{
    public partial class DigitalMarketing : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/MarketingDigital.pptx");
            string fileName = "MarketingDigital.pptx";
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 8; // ID del curso "Marketing Digital" (ajusta según tu BD)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionMarketingDigital.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Marketing Digital";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_MarketingDigital.pdf");
