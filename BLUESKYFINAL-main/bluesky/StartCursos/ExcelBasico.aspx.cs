...
{
    public partial class ExcelBasico : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // (opcional) aquí podrías mostrar el RUT si lo tienes en sesión
            if (!IsPostBack)
            {
                // Ejemplos de cómo podrías traer el rut
                // string rut = Convert.ToString(Session["persrut"]);
                // lblUsuario.Text = rut;
            }
        }
        ...
        {
            string filePath = Server.MapPath("~/ppts/Curso-Excel-Basico.pptx");
            string fileName = "Curso-Excel-Basico.pptx";
        ...
        private bool CursoAprobado(string rut, int cursoId)
        {
            ...
            // mínimo de correctas para alcanzar 60%
    ...
    out int totalIntentos, out bool ultimoFueAprobado)
        {
            ...
            using (var cn = new MySqlConnection(cs))
            {
              ...
              WHERE persrut = @rut AND curso_id = @curso;", cn))
                ...
                // Último intento -> calculamos aprobación con num_correctas
        ...
        /// <summary>
        /// Obtiene el nombre completo del usuario desde la tabla usuario
        /// </summary>
        ...
        /// <summary>
        /// Confirmación de inicio de evaluación desde el modal.
        /// Si el curso ya está aprobado, se muestra modal de curso aprobado en vez de ir a la evaluación.
        /// </summary>
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            if (cursoAprobado)
            {
                // Siempre mostrar el botón de "Realizar evaluación igualmente"
                btnRealizarEvalIgual.Visible = true;

                // (limpia mensaje anterior si existía)
            ...
            // Si NO está aprobado todavía, flujo normal
            Response.Redirect("~/Evaluaciones/EvaluacionExcelBasico.aspx");
        }


        /// <summary>
        /// Descarga nuevamente el certificado desde el modal de curso aprobado
        /// </summary>
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Excel Básico";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                document.SetMargins(80, 60, 70, 60);
                ...
                canvas.SetLineWidth(2)
                      ...
                      .Rectangle(margin, margin, pageSize.GetWidth() - margin * 2, pageSize.GetHeight() - margin * 2)
                      .Stroke();

                // ===== Contenido =====
                document.Add(new Paragraph("BlueSky Financial")
                ...
                document.Add(new Paragraph("CERTIFICADO DE APROBACIÓN")
                    .SetTextAlignment(TextAlignment.CENTER)
                    .SetFontSize(22)
                ...
                document.Add(new Paragraph(nombreCompleto.ToUpperInvariant())
                    .SetTextAlignment(TextAlignment.CENTER)
                    .SetFontSize(20)
                    .SetFontColor(colorTexto));
                ...
                document.Add(new Paragraph("ha aprobado satisfactoriamente el siguiente curso:")
                    .SetTextAlignment(TextAlignment.CENTER)
                    .SetFontSize(13)
                    .SetFontColor(colorDetalle));

                document.Add(new Paragraph(nombreCurso)
                    .SetTextAlignment(TextAlignment.CENTER)
                    .SetFontSize(18)
                    .SetFontColor(colorBorde));
                ...
                document.Add(new Paragraph(
                    "Otorgado en reconocimiento a la correcta realización y aprobación de la evaluación final del programa de formación impartido por la plataforma de capacitación de BlueSky Financial."
                )
                .SetTextAlignment(TextAlignment.CENTER)
                .SetFontSize(11)
                .SetFontColor(colorTexto));
                ...
                // ===== FECHA — ahora con MÁS ESPACIO HACIA LA FIRMA =====
                ...
                document.Add(
                    new Paragraph("Santiago de Chile, " + fecha)
                        ...
                        .SetFontColor(colorTexto)
                        .SetMarginTop(5)
                        .SetMarginBottom(30)   // <<< ANTES 10 — AHORA 30 (más espacio)
                );
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_ExcelBasico.pdf");
        ...
        protected void btnRealizarEvalIgual_Click(object sender, EventArgs e)
        {
            ...
            // Si ya tiene las 3 oportunidades usadas
            if (totalIntentos >= 3)
            {
                // Mensaje en pantalla
            ...
            // Si aún no llega a 3 intentos, puede ir a la evaluación
            Response.Redirect("~/Evaluaciones/EvaluacionExcelBasico.aspx");
        }
