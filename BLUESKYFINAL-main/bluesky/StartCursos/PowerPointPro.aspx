<%@ Page Title="CURSO: POWERPOINT PROFESIONAL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PowerPointPro.aspx.cs" Inherits="bluesky.StartCursos.PowerPointPro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso &amp; evaluación — PowerPoint Intermedio
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Curso-PowerPoint-Intermedio.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación — PowerPoint Intermedio</h2>
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Curso-PowerPoint-Intermedio.pdf") %>';
