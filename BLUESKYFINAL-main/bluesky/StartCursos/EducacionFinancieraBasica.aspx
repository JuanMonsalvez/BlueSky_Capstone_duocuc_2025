<%@ Page Title="CURSO: EDUCACIÓN FINANCIERA BÁSICA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EducacionFinancieraBasica.aspx.cs" Inherits="bluesky.StartCursos.EducacionFinancieraBasica" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        /* Encabezado evaluación: FAQ izq + título centro + timer der */
        .eval-card .eval-header {
            display: grid;
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Educación Financiera
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Educacion financiera.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <!-- ========= CARD INDEPENDIENTE: Evaluación (cabecera) ========= -->
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación Educación Financiera</h2>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <!-- Botón servidor: inicia flujo igual que en Word -->
                    <asp:Button
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Educacion financiera.pdf") %>';
