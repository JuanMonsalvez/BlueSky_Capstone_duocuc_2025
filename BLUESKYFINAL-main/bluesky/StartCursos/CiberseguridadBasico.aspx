<%@ Page Title="CURSO: CIBERSEGURIDAD BÁSICA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CiberseguridadBasico.aspx.cs" Inherits="bluesky.StartCursos.CiberseguridadBasico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Ciberseguridad Básica
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Ciberseguridad_basica_tacticas_y_herramientas.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación Ciberseguridad Básica</h2>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <!-- Botón servidor: igual que otros cursos -->
                    <asp:Button
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Ciberseguridad_basica_tacticas_y_herramientas.pdf") %>';
