<%@ Page Title="Curso: Herramientas de Organización" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HerramientasDeOrganizacion.aspx.cs" Inherits="bluesky.StartCursos.HerramientasDeOrganizacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        .pdf-overlay {
            ...
            gap: 8px;
            z-index: 5;
            pointer-events: none; /* el contenedor ignora eventos */
        }
        ...
        /* Footer centrado dentro de la card */
        .eval-footer {
            display: flex;
            flex-direction: column; /* pager arriba, botón abajo */
        ...
        .faq-button {
            ...
            width: 38px;
            height: 38px;
            border: 1px solid #2563eb; /* azul borde */
            border-radius: 10px;
            ...
            .faq-button:hover {
                background: #1d4ed8; /* azul más oscuro al pasar el mouse */
            }
        ...
        /* Encabezado de evaluación: espacio para botón izq + título centro + timer der */
        .eval-card .eval-header {
            display: grid;
        ...
        .eval-card .eval-title {
            grid-column: 2; /* título centrado en la col 2 */
            justify-self: center;
        }
        ...
        @media (max-width:767px) {
            .eval-card .eval-header {
                grid-template-columns: 1fr 1fr; /* FAQ izq, timer der; título abajo */
            }
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Herramientas para Organización Efectiva del Trabajo
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    <!-- Control incrustado (junto al área del botón nativo de descargar del visor) -->
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Herramientas para la gestion de procesos en la organizacion.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <!-- ========= CARD INDEPENDIENTE: Evaluación (decorativa) ========= -->
            ...
            <div class="eval-header">
                ...
                <button type="button" class="faq-button" aria-label="Ver instrucciones de la evaluación" onclick="openFaq()">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" aria-hidden="true" focusable="false">
                        <path d="M80 160c0-35.3 28.7-64 64-64h32c35.3 0 64 28.7 64 64v3.6c0 21.8-11.1 42.1-29.4 53.8l-42.2 27.1c-25.2 16.2-40.4 44.1-40.4 74V320c0 17.7 14.3 32 32 32s32-14.3 32-32v-1.4c0-8.2 4.2-15.8 11-20.2l-42.2-27.1c36.6-23.6 58.8-64.1 58.8-107.7V160c0-70.7-57.3-128-128-128H144C73.3 32 16 89.3 16 160c0 17.7 14.3 32 32 32s32-14.3 32-32zm80 320a40 40 0 1 0 0-80 40 40 0 1 0 0 80z"></path>
                    </svg>
                    <span class="tooltip" style="font-size: 16px;">Ayuda</span>
                </button>

                <h2 class="eval-title" tabindex="-1">Evaluación Word Básico</h2>
            ...
            <div class="modal-content rounded-3 shadow">
                <div class="modal-header position-relative">
                    ...
                    <button type="button"
                        ...
                        aria-label="Cerrar"
                        onclick="_hideModal('confirmStartModal')">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-outline-secondary" onclick="confirmStartNo()">No</button>
                    <asp:Button
    ...
    <div class="modal fade" id="faqModal" tabindex="-1" aria-labelledby="faqTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" class="btn btn-primary" onclick="_hideModal('faqModal')">Entendido</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Herramientas para la gestion de procesos en la organizacion.pdf") %>';
