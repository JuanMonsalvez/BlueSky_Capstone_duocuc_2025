...
{
    public partial class GestionDeProyectos : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/Gestion de proyectos - herramientas claves.pptx");
            string fileName = "Gestion de proyectos - herramientas claves.pptx";
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 5; // <<< ID del curso "Gestión de Proyectos — Herramientas Claves" (ajusta según tu BD)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionGestionDeProyectos.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Gestión de Proyectos — Herramientas Claves";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_GestionDeProyectos.pdf");
        ...
        protected void btnRealizarEvalIgual_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 5; // mismo ID que arriba
            int totalIntentos;
            bool ultimoFueAprobado;
            ObtenerEstadoIntentos(rut, cursoId, out totalIntentos, out ultimoFueAprobado);
            ...
            Response.Redirect("~/Admin/EvaluacionGestionDeProyectos.aspx");
        }
