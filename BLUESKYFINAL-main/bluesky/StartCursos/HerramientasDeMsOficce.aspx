<%@ Page Title="Curso: Herramientas Ms Oficce" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HerramientasDeMsOficce.aspx.cs" Inherits="bluesky.StartCursos.HerramientasDeMsOficce" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Herramientas Básicas de MS OFICCE
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Herramientas basicas de ms office.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación: Herramientas Básicas de MS Office</h2>
                <div id="evalTimer" class="eval-timer" aria-live="polite">30 minutos : 00 segundos</div>
            </div>
        </div>
    </section>
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Herramientas basicas de ms office.pdf") %>';
