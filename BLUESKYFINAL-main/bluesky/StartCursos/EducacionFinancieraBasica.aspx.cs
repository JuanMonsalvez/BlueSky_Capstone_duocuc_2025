...
{
    public partial class EducacionFinancieraBasica : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/Educacion financiera.pptx");
            string fileName = "Educacion financiera.pptx";
    ...
    out int totalIntentos, out bool ultimoFueAprobado)
        {
            ...
            using (var cn = new MySqlConnection(cs))
            {
              ...
              WHERE persrut = @rut AND curso_id = @curso;", cn))
                ...
                // Último intento: calculamos si fue aprobado en base a num_correctas
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 3; // <<< ID del curso "Educación Financiera Básica" (ajusta según tu BD)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionEducacionFinanciera.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Educación Financiera Básica";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_EducacionFinanciera.pdf");
        ...
        protected void btnRealizarEvalIgual_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 3; // mismo ID que arriba
            int totalIntentos;
            bool ultimoFueAprobado;
            ObtenerEstadoIntentos(rut, cursoId, out totalIntentos, out ultimoFueAprobado);
