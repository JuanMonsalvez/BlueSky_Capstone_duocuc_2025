<%@ Page Title="CURSO: HERRAMIENTAS DE GESTION DE PROCESOS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HerramientasDeGestionProceso.aspx.cs" Inherits="bluesky.StartCursos.HerramientasDeGestionProceso" %>
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Herramientas de Gestión de Procesos
                </h1>
                <br />
                <!-- Información -->
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <div class="pdf-overlay">
                        <a id="pdfFsToggle"
                            ...
                            <svg id="iconEnter" xmlns="http://www.w3.org/2000/svg"
    ...
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación — Herramientas de Gestión de Procesos</h2>
