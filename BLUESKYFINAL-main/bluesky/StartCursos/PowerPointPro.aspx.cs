...
{
    public partial class PowerPointPro : System.Web.UI.Page
    {
        ...
        {
            // Ajusta la ruta real del PPT de este curso
            string filePath = Server.MapPath("~/ppts/Curso-PowerPoint-Intermedio.pptx");
            string fileName = "Curso-PowerPoint-Intermedio.pptx";
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 11; // PowerPoint Intermedio (ajusta al ID real)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionPowerPointIntermedio.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "PowerPoint Intermedio"; // ajusta el nombre como quieras
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_PowerPointIntermedio.pdf");
        ...
        // ====== NUEVO: total de preguntas por curso ======
