...
{
    public partial class HerramientasDeGestionProceso : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/Herramientas para la gestion de procesos en la organizacion.pptx");
            string fileName = "Herramientas para la gestion de procesos en la organizacion.pptx";
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 9; // Herramientas de Gestión de Procesos
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionHerramientasDeProceso.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Herramientas de Gestión de Procesos";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_HerramientasDeGestionDeProcesos.pdf");
