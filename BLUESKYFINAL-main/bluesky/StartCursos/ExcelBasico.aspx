<%@ Page Title="CURSO: EXCEL BÁSICO" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ExcelBasico.aspx.cs" Inherits="bluesky.StartCursos.ExcelBasico" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        .return-wrap {
            /* sacamos el absolute */
            position: static; /* o simplemente bórralo */
            /* y usamos margen normal para bajarlo un poco */
            margin-top: 0.5rem;
        }
    ...
    <section id="material" class="container mt-2 mb-0 p-0">
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">Contenido del curso & evaluación — Excel Básico
                </h1>
                <br />
                <!-- Información -->
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Curso-Excel-Basico.pdf") %>#page=1&view=FitH&pagemode=none"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 shadow">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <!-- BOTÓN CERRAR (ahora es ASP y el servidor lo puede ocultar) -->
    ...
    <script type="text/javascript">
        // Mostrar modal sin depender de Bootstrap
        function _showModal(id) {
            ...
            // Crear backdrop propio (por si quieres oscurecer el fondo)
            var backdrop = document.createElement('div');
            backdrop.className = 'modal-backdrop fade show custom-backdrop';
            document.body.appendChild(backdrop);
        }

        // Ocultar modal (y quitar backdrop)
        function _hideModal(id) {
            ...
            // Eliminar solo nuestros backdrops custom
        ...
        function showConfirmStart() {
            ...
            return false; // evita el postback del botón "Iniciar evaluación"
        }

        // Clic en "No" del modal de confirmación
