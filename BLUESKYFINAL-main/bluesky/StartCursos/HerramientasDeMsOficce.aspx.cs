...
{
    public partial class HerramientasDeMsOficce : System.Web.UI.Page
    {
        ...
        {
            string filePath = Server.MapPath("~/ppts/Herramientas basicas de ms office.pptx");
            string fileName = "Herramientas basicas de ms office.pptx";
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionHerramientasOficceBasica.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Herramientas Básicas de MS OFICCE";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_HerramientasMsOffice.pdf");
