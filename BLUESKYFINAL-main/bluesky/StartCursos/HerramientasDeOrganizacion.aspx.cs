...
{
    public partial class HerramientasDeOrganizacion : System.Web.UI.Page
    {
    ...
    out int totalIntentos, out bool ultimoFueAprobado)
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 7; // ID del curso "Herramientas de Organización" (ajusta según tu BD)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionHerramientasDeOrganizacion.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Herramientas para Organización Efectiva del Trabajo";
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_HerramientasOrganizacion.pdf");
