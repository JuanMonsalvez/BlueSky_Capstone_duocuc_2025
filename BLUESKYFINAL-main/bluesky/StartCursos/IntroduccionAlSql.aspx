<%@ Page Title="CURSO: INTRODUCCION A SQL" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IntroduccionAlSql.aspx.cs" Inherits="bluesky.StartCursos.IntroduccionAlSql" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="card course-eval-card">
            <div class="card-header">
                <h1 class="h5 m-0 text-center" style="font-size: 24px;">
                    Contenido del curso &amp; evaluación — Introducción a SQL
                </h1>
                <br />
                <!-- Información -->
                <div class="info-inline" style="font-size: 15px;">
                    <div><i class="fa fa-database"></i><strong>Material:</strong> PPT</div>
            ...
            <div class="card-body">
                ...
                <div id="pdfContainer" class="pdf-container">
                    ...
                    <iframe
                        ...
                        src="<%: ResolveUrl("~/pdf/Curso-Analisis-de-Datos-Intermedio.pdf") %>#page=1&view=FitH&pagemode=none"
    ...
    <!-- ========= CARD INDEPENDIENTE: Evaluación (solo header, decorativo) ========= -->
    <section id="evaluacion" class="container" style="margin: 18px auto 32px;">
        <div id="evaluationCard" class="card eval-card" style="display: none;">
            <div class="eval-header">
                ...
                <h2 class="eval-title" tabindex="-1">Evaluación — Introducción a SQL</h2>
    ...
    <script type="text/javascript">
        ...
        function openFullScreen() {
            ...
            var base = '<%= ResolveUrl("~/pdf/Curso-Analisis-de-Datos-Intermedio.pdf") %>';
