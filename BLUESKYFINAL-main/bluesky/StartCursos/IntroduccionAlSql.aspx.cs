...
{
    public partial class IntroduccionAlSql : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                // Ejemplo: podrías mostrar el rut
        ...
        {
            // Ruta real del PPT de este curso
            string filePath = Server.MapPath("~/ppts/Curso-Analisis-de-Datos-Intermedio.pptx");
            string fileName = "Curso-Analisis-de-Datos-Intermedio.pptx";
        ...
        private void ObtenerEstadoIntentos(string rut, int cursoId, out int totalIntentos, out bool ultimoFueAprobado)
        {
            totalIntentos = 0;
            ...
            using (var cn = new MySqlConnection(cs))
            {
              ...
              WHERE persrut = @rut AND curso_id = @curso;", cn))
                ...
                // Último intento según num_correctas
              ...
              LIMIT 1;", cn))
                {
                    ...
                    {
                        int nc = Convert.ToInt32(result);
                        ultimoFueAprobado = nc >= minCorrectas;
                    }
                }
            }
        }
        ...
        protected void btnConfirmarInicioEval_Click(object sender, EventArgs e)
        {
            ...
            int cursoId = 12; // Introducción a SQL (ajusta al ID real)
            ...
            Response.Redirect("~/Evaluaciones/EvaluacionIntroduccionSQL.aspx");
        }
        ...
        protected void btnDescargarCertificadoAprobado_Click(object sender, EventArgs e)
        {
            ...
            string nombreCurso = "Introducción a SQL"; // nombre mostrado en el certificado
            ...
            using (var ms = new MemoryStream())
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=Certificado_Introduccion_SQL.pdf");
