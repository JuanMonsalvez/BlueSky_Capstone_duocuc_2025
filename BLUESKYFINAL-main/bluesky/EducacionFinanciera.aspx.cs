...
namespace bluesky
{
    public partial class EducacionFinanciera : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/EducacionFinancieraBasica.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-educacion-financiera.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-educacion-financiera.pdf");
