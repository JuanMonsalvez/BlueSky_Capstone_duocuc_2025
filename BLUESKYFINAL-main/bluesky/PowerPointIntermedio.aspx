<%@ Page Title="Curso: PowerPoint Profesional" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PowerPointIntermedio.aspx.cs" Inherits="bluesky.PowerPointProfesional" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
             style="background-image: url('<%: ResolveUrl("~/images/Microsoft-Powerpoint.png") %>');"
             aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>
        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">PowerPoint Profesional</h1>
            <br />
            ...
            <ul class="meta-grid" role="list">
                ...
                <li class="meta-card" role="listitem">
                    ...
                    <div class="meta-body">
                        ...
                        <p class="meta-value">
                            <asp:Label ID="lblNivel" runat="server" Text="Intermedio–Avanzado"></asp:Label>
                        </p>
                    </div>
                </li>
                <li class="meta-card" role="listitem">
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Profesionales que comunican resultados, propuestas o capacitaciones y desean crear presentaciones
                claras, visualmente consistentes y de alto impacto, optimizando su tiempo de producción.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Manejo básico de PowerPoint (insertar textos, imágenes y formas).</li>
                    <li>Nociones de diseño básicas (alineación, contraste y jerarquía).</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Microsoft PowerPoint 2019 o Microsoft 365 (recomendado).</li>
                    <li>Fuentes corporativas y manual de marca (si aplica).</li>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fundamentos de diseño y consistencia</h3>
                    <p class="mod-card__subtitle">Plantillas, patrón de diapositivas y estilos</p>
                    <ul class="mod-card__list">
                        <li>Uso profesional del Patrón de diapositivas: diseños, fuentes y colores.</li>
                        <li>Temas, variantes y guías para coherencia visual.</li>
                        <li>Grid, alineación y espaciado: reglas rápidas para orden visual.</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Storytelling y visualización</h3>
                    <p class="mod-card__subtitle">Narrativa, datos y diagramas</p>
                    <ul class="mod-card__list">
                        <li>Estructuras narrativas (SCQA, problema–solución, 3 actos).</li>
                        <li>Gráficos efectivos y Data-Ink ratio; errores a evitar.</li>
                        <li>SmartArt, iconos y diagramas personalizados con formas.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Animaciones y transiciones avanzadas</h3>
                    <p class="mod-card__subtitle">Enfoque profesional (menos es más)</p>
                    <ul class="mod-card__list">
                        <li>Ruta de animación: énfasis, entrada/salida y trayectorias.</li>
                        <li>Transición Morf y escenas paso a paso (revelado por capas).</li>
                        <li>Panel de animación, temporización y disparadores (triggers).</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Multimedia, colaboración y entrega</h3>
                    <p class="mod-card__subtitle">Grabación, exportación y control</p>
                    <ul class="mod-card__list">
                        <li>Inserción/edición de audio y video; grabación con narración.</li>
                        <li>Compatibilidad, empaquetado y exportación (PDF/MP4/Show).</li>
                        <li>Colaboración en 365, comentarios, revisión y control de versiones.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos de diseño y consistencia</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Crear/ajustar plantilla corporativa desde el Patrón.</li>
                        <li>Estilos tipográficos: jerarquía, tamaños y espaciados.</li>
                        <li>Paletas seguras; contraste y accesibilidad (WCAG rápida).</li>
                        <li>Bancos de recursos: íconos, mockups y fotos consistentes.</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Storytelling y visualización</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Storyboard: del brief a la secuencia de diapositivas.</li>
                        <li>Elección del gráfico correcto según objetivo.</li>
                        <li>Diagramas custom con formas y combinación/unión.</li>
                        <li>Uso de imágenes y recortes con enfoque visual (foco/zoom).</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Animaciones y transiciones avanzadas</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Secuencias con Morf + panel de animación (capas).</li>
                        <li>Microinteracciones: desvanecer, barrer, énfasis discreto.</li>
                        <li>Sincronización con narración o clic (triggers).</li>
                        <li>Buenas prácticas para mantener FPS/fluidez.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel4" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Multimedia, colaboración y entrega</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Grabación de presentación con cámara y tiempos.</li>
                        <li>Exportación a MP4, PDF interactivo y PowerPoint Show.</li>
                        <li>Presentador: vista del moderador, notas y atajos clave.</li>
                        <li>Revisión por pares, control de versiones y checklist final.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
