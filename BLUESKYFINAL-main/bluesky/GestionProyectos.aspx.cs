...
namespace bluesky
{
    public partial class GestionProyectos : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/GestionDeProyectos.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-gestion-proyectos.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-gestion-proyectos.pdf");
