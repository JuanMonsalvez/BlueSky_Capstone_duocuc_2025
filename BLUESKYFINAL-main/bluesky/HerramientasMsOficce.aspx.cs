...
namespace bluesky
{
    public partial class HerramientasMsOficce : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/HerramientasDeMsOficce.aspx");
        }
        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-ms-office.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-ms-office.pdf");
