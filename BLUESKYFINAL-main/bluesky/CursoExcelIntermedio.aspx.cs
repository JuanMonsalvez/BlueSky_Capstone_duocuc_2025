...
namespace bluesky
{
    public partial class CursoExcelIntermedio : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // Alumnos sin sesión → redirigir a IniciarSesion.aspx
        ...
        {
            Response.Redirect("~/StartCursos/ExcelIntermedio.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-excel-intermedio.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-excel-intermedio.pdf");
