...
namespace bluesky
{
    public partial class MarketingDigital : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/DigitalMarketing.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-marketing-digital.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-marketing-digital.pdf");
