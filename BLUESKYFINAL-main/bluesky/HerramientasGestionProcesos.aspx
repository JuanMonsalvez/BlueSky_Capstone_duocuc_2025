<%@ Page Title="Curso: Herramientas Gestion Organización" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HerramientasGestionProcesos.aspx.cs" Inherits="bluesky.HerramientasGestionProcesos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
             style="background-image: url('<%: ResolveUrl("~/images/Proceso-organizacional.jpeg") %>');"
             aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>
        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Herramientas para la gestión de procesos en la organización</h1>
            <br />
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Líderes de área, analistas, PMO y equipos que buscan estandarizar, medir y mejorar procesos
                para elevar la eficiencia, la calidad de servicio y el cumplimiento normativo.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Nociones básicas de gestión y trabajo en equipo.</li>
                    <li>Conocimiento del proceso actual de su área (deseable).</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Herramienta de modelado (Bizagi Modeler, draw.io, Visio o similar).</li>
                    <li>Suite ofimática (Microsoft 365 o Google Workspace).</li>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fundamentos y levantamiento</h3>
                    <p class="mod-card__subtitle">Mapa de procesos y alcance</p>
                    <ul class="mod-card__list">
                        <li>Cadena de valor, mapa de procesos y niveles.</li>
                        <li>Levantamiento AS-IS: SIPOC, entrevistas y workshop.</li>
                        <li>Roles y gobernanza: dueño de proceso, RACI.</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Modelación y diseño</h3>
                    <p class="mod-card__subtitle">BPMN, riesgos y controles</p>
                    <ul class="mod-card__list">
                        <li>BPMN básico: eventos, actividades, compuertas y pools.</li>
                        <li>Identificación de desperdicios (Lean) y cuellos de botella.</li>
                        <li>Riesgos, controles y cumplimiento (ISO 9001 alineado).</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Medición y mejora</h3>
                    <p class="mod-card__subtitle">KPI, tableros y PDCA</p>
                    <ul class="mod-card__list">
                        <li>KPI de proceso: tiempo de ciclo, lead time, calidad, costo.</li>
                        <li>Tableros ligeros y gestión visual (Excel/Sheets, Power BI básico).</li>
                        <li>Mejora continua: PDCA, 5 porqués, A3 y estandarización (SOP).</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Implementación y automatización</h3>
                    <p class="mod-card__subtitle">Workflow y cambio</p>
                    <ul class="mod-card__list">
                        <li>TO-BE y roadmap de implementación.</li>
                        <li>Automatizaciones ligeras (Power Automate, Apps Script, Zapier).</li>
                        <li>Gestión del cambio: comunicación, capacitación y adopción.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos y levantamiento</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Cadena de valor y tipologías: estratégicos, clave y soporte.</li>
                        <li>SIPOC y mapeo rápido con notas adhesivas (Miro/Whiteboard).</li>
                        <li>Checklist de levantamiento y validación con stakeholders.</li>
                        <li>Matriz RACI y definición de dueños de proceso (process owner).</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Modelación y diseño</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>BPMN: buenas prácticas de diagramación y legibilidad.</li>
                        <li>Detección de desperdicios (DOWNTIME) y balanceo de carga.</li>
                        <li>Riesgos operacionales y controles preventivos/detectivos.</li>
                        <li>Vinculación con políticas/procedimientos e ISO 9001 (enfoque a procesos).</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Medición y mejora</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Definición operacional de KPI y metas; semáforos y umbrales.</li>
                        <li>Dashboard ágil (Excel/Sheets/Power BI) y gestión visual diaria.</li>
                        <li>DMAIC/PDCA aplicado: causa raíz (Ishikawa, 5 porqués) y A3.</li>
                        <li>Estandarización: SOP, checklists y control de cambios.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel4" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Implementación y automatización</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Diseño TO-BE, criterios de priorización y quick wins.</li>
                        <li>Automatizaciones: flujos de aprobación y formularios (Power Automate/Apps Script/Zapier).</li>
                        <li>Plan de adopción: comunicación, capacitación y soporte.</li>
                        <li>Medición post-implementación y cierre de brechas.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
