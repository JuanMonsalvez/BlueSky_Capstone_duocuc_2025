...
namespace bluesky
{
    public partial class Ciberseguridad : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/CiberseguridadBasico.aspx");
        }
        ...
        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Server.MapPath("~/docs/programa-ciberseguridad-basica.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-ciberseguridad-basica.pdf");
