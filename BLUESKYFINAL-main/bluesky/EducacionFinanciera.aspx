 ...
 <%@ Page Title="Curso: Educacion Financiera" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EducacionFinanciera.aspx.cs" Inherits="bluesky.EducacionFinanciera" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
        style="background-image: url('<%: ResolveUrl("~/images/educacion-financiera1.jfif") %>');"
        aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>

        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Educación Financiera</h1>
            <br />
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Personas sin formación financiera que desean ordenar sus finanzas personales,
                comenzar a ahorrar e invertir con criterios simples y tomar mejores decisiones
                sobre deudas y metas.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Manejo básico de computador y navegación por Internet.</li>
                    <li>No se requieren conocimientos financieros previos.</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>PC/Mac o tablet con navegador actualizado y conexión estable a Internet.</li>
                    <li>Cuenta de correo para recibir material descargable (PDF y planillas).</li>
                    <li>Calculadora (física o app) y, opcionalmente, Excel/Google Sheets.</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                ...
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fundamentos financieros</h3>
                    <p class="mod-card__subtitle">Conceptos clave y diagnóstico personal</p>
                    <ul class="mod-card__list">
                        <li>Ingreso, gasto, ahorro, patrimonio y flujo de caja</li>
                        <li>Inflación, interés simple/compuesto (intuición práctica)</li>
                        <li>Radiografía financiera personal (situación actual)</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Presupuesto y ahorro</h3>
                    <p class="mod-card__subtitle">Organización del dinero y metas SMART</p>
                    <ul class="mod-card__list">
                        <li>Métodos 50/30/20 y sobres; control de gastos</li>
                        <li>Fondo de emergencia y hábitos de ahorro</li>
                        <li>Plan de metas: corto, mediano y largo plazo</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Deudas y crédito</h3>
                    <p class="mod-card__subtitle">Uso responsable y estrategias de pago</p>
                    <ul class="mod-card__list">
                        <li>Tipos de deuda, costo real y CAE/TCEA</li>
                        <li>Score crediticio y buenas prácticas</li>
                        <li>Métodos bola de nieve y avalancha</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Inversión y planificación</h3>
                    <p class="mod-card__subtitle">Primeros pasos para invertir y protegerse</p>
                    <ul class="mod-card__list">
                        <li>Horizonte, riesgo y diversificación (nociones)</li>
                        <li>Instrumentos básicos: depósitos, fondos, ETF (visión general)</li>
                        <li>Plan financiero simple: checklist y próximos pasos</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos financieros</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Diferencia entre ingreso, gasto, ahorro y patrimonio.</li>
                        <li>Interés simple y compuesto con ejemplos cotidianos.</li>
                        <li>Inflación y poder adquisitivo.</li>
                        <li>Diagnóstico personal: hoja de balance y flujo de caja básico.</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Presupuesto y ahorro</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Cómo armar un presupuesto: 50/30/20, sobres y categorías.</li>
                        <li>Control de gastos: registro simple y alertas.</li>
                        <li>Ahorro automático, fondo de emergencia y cuentas separadas.</li>
                        <li>Definir metas SMART y priorizarlas en el tiempo.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Deudas y crédito</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Tarjetas, créditos de consumo e hipotecarios: costos y comisiones.</li>
                        <li>Tasas, CAE/TCEA y costo total del crédito.</li>
                        <li>Cuidado del historial/score crediticio.</li>
                        <li>Estrategias de pago: bola de nieve vs. avalancha (comparativa).</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Inversión y planificación</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Perfil de riesgo, horizonte y diversificación.</li>
                        <li>Opciones iniciales: depósitos, fondos mutuos y ETF (alto nivel).</li>
                        <li>Seguros y protección básica.</li>
                        <li>Plan financiero simple con checklist de implementación.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
            ...
            <ul class="methodology-grid" role="list">
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="1" aria-labelledby="m1-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Clases en vivo con ejercicios guiados, plantillas descargables y práctica autónoma con feedback.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul class="method-list">
                                ...
                                <li>Material descargable (planillas, checklists y guías).</li>
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="2" aria-labelledby="m2-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Quiz por módulo y ejercicio aplicado (presupuesto, plan de deuda e inversión) con rúbrica clara.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul>
                                ...
                                <li>Entregables prácticos: presupuesto, plan de ahorro y estrategia de pago de deudas.</li>
