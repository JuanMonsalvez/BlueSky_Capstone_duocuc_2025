...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        .method-title {
            margin: 2px 0 6px;
            font-weight: 800;
            font-size: 1.05rem; /* similar a mod-card__title */
            color: #0f172a;
        }
    ...
    <section class="hero hero--curso"
        style="background-image: url('<%= ResolveUrl("~/images/excel.jpg") %>');"
        aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>

        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Herramientas de Excel básico</h1>
            <br />
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos de Excel</h3>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Formato, tablas y filtros</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Funciones esenciales</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Gráficos e impresión</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
            ...
            <ul class="methodology-grid" role="list">
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="1" aria-labelledby="m1-title">
                    ...
                    <div class="method-body">
                        ...
                        <div class="method-modal-content" hidden>
                            <p><strong>La metodología combina aprendizaje activo con recursos breves y aplicados:</strong></p>
                            <ul>
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="2" aria-labelledby="m2-title">
                    ...
                    <div class="method-body">
                        ...
                        <div class="method-modal-content" hidden>
                            <p><strong>Evaluamos el progreso con foco en evidencias de aprendizaje:</strong></p>
                            <ul>
