<%@ Page Title="Curso: Excel Intermedio" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CursoExcelIntermedio.aspx.cs" Inherits="bluesky.CursoExcelIntermedio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
             style="background-image: url('<%: ResolveUrl("~/images/ExcelIntermdio.jpeg") %>');"
             aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>
        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Herramientas de Excel Intermedio</h1>
            <br />
            ...
            <ul class="meta-grid" role="list">
                ...
                <li class="meta-card" role="listitem">
                    ...
                    <div class="meta-body">
                        ...
                        <p class="meta-value">
                            <asp:Label ID="lblNivel" runat="server" Text="Intermedio"></asp:Label>
                        </p>
                    </div>
                </li>
                <li class="meta-card" role="listitem">
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Personas que ya dominan lo básico de Excel y necesitan analizar datos, crear reportes dinámicos
                y automatizar tareas frecuentes con mayor eficiencia.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Excel nivel básico (fórmulas simples, formato, filtros, gráficos básicos).</li>
                    <li>Conocimientos de manejo de archivos y carpetas en Windows/Mac.</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Microsoft Excel 2019 o Microsoft 365 (recomendado).</li>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fórmulas y funciones clave</h3>
                    <p class="mod-card__subtitle">Buscar, combinar y limpiar datos</p>
                    <ul class="mod-card__list">
                        <li>Funciones condicionales y de texto: SI, Y/O, IZQUIERDA/DERECHA, EXTRAE, UNIRCADENAS.</li>
                        <li>Búsquedas modernas: BUSCARX, FILTRAR, ORDENAR, ÚNICOS.</li>
                        <li>Combinar datos: INDICE+COINCIDIR vs BUSCARV; referencias absolutas/mixtas.</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Tablas, validación y formato</h3>
                    <p class="mod-card__subtitle">Estructura, control y resaltado</p>
                    <ul class="mod-card__list">
                        <li>Tablas de Excel: nombres estructurados, segmentación y totales.</li>
                        <li>Validación de datos: listas, reglas, mensajes y control de errores.</li>
                        <li>Formato condicional avanzado y reglas con fórmulas.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Análisis con Tablas Dinámicas</h3>
                    <p class="mod-card__subtitle">Resumen y visualización</p>
                    <ul class="mod-card__list">
                        <li>Creación y personalización de tablas dinámicas.</li>
                        <li>Campos calculados, segmentadores y líneas de tiempo.</li>
                        <li>Gráficos dinámicos y diseño de reportes ejecutivos.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Power Query y automatización ligera</h3>
                    <p class="mod-card__subtitle">ETL básico y macros</p>
                    <ul class="mod-card__list">
                        <li>Power Query: importar, transformar y combinar (ETL básico).</li>
                        <li>Actualización de consultas y flujo reproducible.</li>
                        <li>Grabadora de macros: tareas repetitivas y buenas prácticas.</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fórmulas y funciones clave</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Errores comunes (#N/A, #¡VALOR!, #¡REF!) y cómo depurarlos.</li>
                        <li>Funciones de fecha/hora y agregación (SUMAR.SI.CONJUNTO, CONTAR.SI.CONJUNTO).</li>
                        <li>Buenas prácticas: nombres definidos y auditoría de fórmulas.</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Tablas, validación y formato</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Diseño de esquema robusto para reportes reutilizables.</li>
                        <li>Reglas de validación con fórmulas y mensajes personalizados.</li>
                        <li>Plantillas de formato y estilos de celda/tabla.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Análisis con Tablas Dinámicas</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Diseño de vistas múltiples y KPI por dimensión.</li>
                        <li>Medidas y agrupaciones; trucos de orden y formato.</li>
                        <li>Gráficos dinámicos y recomendaciones de visualización.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel4" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Power Query y automatización ligera</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Transformaciones típicas: dividir/combinar columnas, pivotar/despivotar.</li>
                        <li>Combinaciones (merge/append) y actualización de orígenes.</li>
                        <li>Macros con grabadora: buenas prácticas de seguridad y mantenimiento.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
