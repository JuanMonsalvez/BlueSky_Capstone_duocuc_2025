...
namespace bluesky
{
    public partial class CursoWordBasico : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/WordBasico.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-word-basico.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-word-basico.pdf");
