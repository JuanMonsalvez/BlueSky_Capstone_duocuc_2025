...
namespace bluesky
{
    public partial class IntroduccionSQL : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("~/StartCursos/IntroduccionAlSql.aspx");
        }

        protected void btnPrograma_Click(object sender, EventArgs e)
        {
            // Ruta física del PDF dentro de la carpeta "docs"
            string filePath = Server.MapPath("~/docs/programa-sql-introduccion.pdf");
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Response.AddHeader("Content-Disposition", "attachment; filename=programa-sql-introduccion.pdf");
