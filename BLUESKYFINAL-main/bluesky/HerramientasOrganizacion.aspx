<%@ Page Title="Curso: Herramientas Organización Efectiva" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HerramientasOrganizacion.aspx.cs" Inherits="bluesky.HerramientasOrganizacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="hero hero--curso"
             style="background-image: url('<%: ResolveUrl("~/images/herramientas1.jpeg") %>');"
             aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>
        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Herramientas para organización efectiva del trabajo</h1>
            <br />
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Profesionales y equipos que desean organizar prioridades, tareas, comunicaciones y proyectos
                para trabajar con foco y menos estrés.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    ...
                    <li>Nociones de correo y calendario.</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Microsoft 365 o Google Workspace.</li>
                    <li>App de tareas/tableros (Planner, Trello, Asana o similar).</li>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                ...
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Tiempo y prioridades</h3>
                    <p class="mod-card__subtitle">Planeación semanal y foco</p>
                    <ul class="mod-card__list">
                        <li>Objetivos SMART y planificación semanal</li>
                        <li>Matriz de Eisenhower y Pomodoro/Timeboxing</li>
                        <li>Calendario y bloques de concentración</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Gestión de tareas y tableros</h3>
                    <p class="mod-card__subtitle">Listas, Kanban y seguimiento</p>
                    <ul class="mod-card__list">
                        <li>Inbox, categorización y priorización</li>
                        <li>Kanban (Planner/Trello) y vistas calendario</li>
                        <li>Revisiones diarias/semanales y métricas simples</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Correo y comunicación efectiva</h3>
                    <p class="mod-card__subtitle">Bandeja cero y reuniones útiles</p>
                    <ul class="mod-card__list">
                        <li>Reglas, plantillas y búsqueda avanzada</li>
                        <li>Bandeja organizada y seguimiento</li>
                        <li>Reuniones: agenda, notas y acuerdos</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Productividad digital y automatización</h3>
                    <p class="mod-card__subtitle">Plantillas y flujos ligeros</p>
                    <ul class="mod-card__list">
                        <li>Notas y documentación (OneNote/Notion)</li>
                        <li>Plantillas y checklists reutilizables</li>
                        <li>Automatizaciones básicas (Power Automate/Zapier)</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button" class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Tiempo y prioridades</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Diseño de semana: objetivos, bloques y buffers.</li>
                        <li>Matriz urgente/importante y criterios de priorización.</li>
                        <li>Timeboxing vs. Pomodoro: cuándo usar cada uno.</li>
                        <li>Checklist de foco y gestión de interrupciones.</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Gestión de tareas y tableros</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Arquitectura de listas: Inbox, Siguiente, Esperando, Algún día.</li>
                        <li>Kanban: columnas, WIP y políticas de “hecho”.</li>
                        <li>Etiquetas, fechas límite, recordatorios y vistas.</li>
                        <li>Revisiones: diaria (5’), semanal (30’) y mensual (45’).</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel3" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Correo y comunicación efectiva</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Bandeja cero: procesar, decidir y archivar.</li>
                        <li>Reglas/filtros, plantillas y “enviar más tarde”.</li>
                        <li>Minutas efectivas: agenda, responsables y plazos.</li>
                        <li>Buenas prácticas en chats y reuniones virtuales.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog" aria-labelledby="modsModalLabel4" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Productividad digital y automatización</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Notas y conocimiento: OneNote/Notion, estructura y enlaces.</li>
                        <li>Plantillas y checklists reutilizables.</li>
                        <li>Automatizaciones básicas con Power Automate/Zapier.</li>
                        <li>Seguridad ligera: permisos y versiones en la nube.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
