<%@ Page Title="Curso: Ciberseguridad Básica" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Ciberseguridad.aspx.cs" Inherits="bluesky.Ciberseguridad" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <!-- ===========================
         ESTILOS ESPECÍFICOS DE LA PÁGINA
         (mismos del curso Excel/Educación Financiera)
         =========================== -->
    <style>
        /* ---------- HERO DEL CURSO ---------- */
        .hero.hero--curso {
    ...
    <section class="hero hero--curso"
        style="background-image: url('<%: ResolveUrl("~/images/CIBERSEGURIDAD1.jfif") %>');"
        aria-labelledby="curso-title">
        <div class="hero__overlay" aria-hidden="true"></div>

        <div class="hero__inner text-center">
            <h1 id="curso-title" class="hero__title">Ciberseguridad Básica: Tácticas y Herramientas</h1>
            <br />
    ...
    <section class="course-target" aria-labelledby="target-title">
        <div class="container">
            ...
            <p class="course-target__text">
                Personas sin experiencia técnica que desean proteger sus cuentas, equipos y datos,
                comprender los riesgos más comunes y aplicar buenas prácticas de seguridad en el trabajo y en casa.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>Manejo básico de computador, correo y navegación por Internet.</li>
                    <li>No se requieren conocimientos en ciberseguridad.</li>
                </ul>
            </div>
            ...
            <div class="course-reqs__block">
                ...
                <ul class="course-reqs__list">
                    <li>PC/Mac con navegador actualizado y conexión estable a Internet.</li>
                    <li>Acceso a una cuenta de correo y a un teléfono para MFA (autenticación en dos pasos).</li>
                    <li>Opcional: instalación de un antivirus gratuito y un gestor de contraseñas.</li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="mods-grid">
                ...
                <article class="mod-card" aria-labelledby="mod1-title">
                    <h3 id="mod1-title" class="mod-card__title">Módulo 1: Fundamentos de ciberseguridad</h3>
                    <p class="mod-card__subtitle">Riesgos, conceptos y marco mental</p>
                    <ul class="mod-card__list">
                        <li>Tríada CIA: confidencialidad, integridad y disponibilidad</li>
                        <li>Amenazas comunes: phishing, malware, ransomware, ingeniería social</li>
                        <li>Buenas prácticas base y modelo de capas de defensa</li>
                    </ul>
                ...
                <article class="mod-card" aria-labelledby="mod2-title">
                    <h3 id="mod2-title" class="mod-card__title">Módulo 2: Cuentas y dispositivos seguros</h3>
                    <p class="mod-card__subtitle">Contraseñas, MFA y configuración</p>
                    <ul class="mod-card__list">
                        <li>Gestores de contraseñas y políticas de passphrase</li>
                        <li>MFA/2FA: apps autenticadoras vs. SMS</li>
                        <li>Higiene de dispositivos: actualizaciones, bloqueo, cifrado y navegadores</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod3-title">
                    <h3 id="mod3-title" class="mod-card__title">Módulo 3: Redes y protección de datos</h3>
                    <p class="mod-card__subtitle">Wi-Fi, VPN, copias y cifrado</p>
                    <ul class="mod-card__list">
                        <li>Buenas prácticas en Wi-Fi doméstico y público</li>
                        <li>VPN: cuándo sí, cuándo no (nociones)</li>
                        <li>Backups 3-2-1, cifrado básico y clasificación de datos</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
                ...
                <article class="mod-card" aria-labelledby="mod4-title">
                    <h3 id="mod4-title" class="mod-card__title">Módulo 4: Respuesta básica e indicadores</h3>
                    <p class="mod-card__subtitle">Detección, reporte y herramientas</p>
                    <ul class="mod-card__list">
                        <li>Señales de compromiso y qué hacer ante un incidente</li>
                        <li>Verificación de correos y URLs, análisis de adjuntos sospechosos (seguro)</li>
                        <li>Antivirus/EDR, registros (logs) y checklist de respuesta</li>
                    </ul>
                    <div class="mod-card__actions">
                        <button type="button"
                            class="btn btn-mod-see"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel1" class="modal-title">Módulo 1: Fundamentos de ciberseguridad</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Panorama de amenazas y vectores de ataque más frecuentes.</li>
                        <li>Tríada CIA, riesgo vs. impacto y mentalidad “capa sobre capa”.</li>
                        <li>Falsos positivos, sesgos y cómo reconocer ingeniería social.</li>
                        <li>Buenas prácticas universales (actualiza, desconfía, verifica).</li>
                    </ul>
                </div>
    ...
    <div class="modal fade modal-mods" id="modsModal2" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel2" class="modal-title">Módulo 2: Cuentas y dispositivos seguros</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Creación y almacenamiento de contraseñas robustas (gestores).</li>
                        <li>Activación de MFA/2FA y recuperación segura de cuentas.</li>
                        <li>Endurecimiento básico de Windows/macOS y móviles.</li>
                        <li>Navegadores: extensiones útiles, bloqueo de rastreadores y actualizaciones.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal3" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel3" class="modal-title">Módulo 3: Redes y protección de datos</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Seguridad en Wi-Fi doméstico y público: SSID, WPA2/3 y router.</li>
                        <li>VPN: beneficios, limitaciones y uso correcto.</li>
                        <li>Estrategia 3-2-1 de copias de seguridad y verificación periódica.</li>
                        <li>Cifrado básico de archivos/discos y clasificación de la información.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <div class="modal fade modal-mods" id="modsModal4" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document" aria-modal="true">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="modsModalLabel4" class="modal-title">Módulo 4: Respuesta básica e indicadores</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <div class="modal-body">
                    <ul class="mod-detail-list">
                        <li>Cómo actuar ante phishing, malware o pérdida de dispositivo.</li>
                        <li>Verificación de remitentes y URLs; sandbox seguro para adjuntos.</li>
                        <li>Antivirus/EDR: escaneos, cuarentena y actualizaciones.</li>
                        <li>Checklist de respuesta, reporte y recuperación.</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Cerrar</button>
    ...
    <!-- ================================
     ...
     (misma estructura visual que Excel/Educación)
     ================================ -->
    <section id="methodology" class="methodology-pro v2" aria-labelledby="methodology-title" style="padding: 40px 0 48px; background: #ffffff;">
        <div class="container" style="max-width: 1100px;">
            <header class="text-center" style="margin-bottom: 18px;">
                <h2 id="methodology-title" class="methodology-title" style="font-weight: 900; letter-spacing: .2px; line-height: 1.15; font-size: clamp(2rem,1.2vw + 1.7rem,2.3rem); margin: 0; color: #0f172a;">Metodología y certificación
                </h2>
            </header>
            ...
            <ul class="methodology-grid" role="list">
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="1" aria-labelledby="m1-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Clases en vivo con demostraciones, prácticas guiadas y plantillas; cápsulas on-demand y feedback aplicado.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul class="method-list">
                                ...
                                <li>Checklist de seguridad personal y plantillas de configuración.</li>
                                <li>Actividades con rúbrica y feedback personalizado.</li>
                ...
                <li class="method-card" role="listitem" tabindex="0" data-step="2" aria-labelledby="m2-title">
                    ...
                    <div class="method-body">
                        ...
                        <p class="method-text">
                            Quiz por módulo y ejercicios aplicados: hardening básico, plan de copias y checklist de respuesta.
                        </p>
                        ...
                        <div class="method-modal-content" hidden>
                            ...
                            <ul>
                                ...
                                <li>Entregables prácticos por módulo (contraseñas/MFA, backups, respuesta a incidentes).</li>
    ...
    <!-- SCRIPTS: MODAL METODOLOGÍA (igual que Excel/Educación) -->
    <script>
        (function () {
